...
import ResumeShow from '@/components/content/resumeShow';
  ...
  const takeScreenshot = () => {
    if (contentRef.current) {
      ...
      .then(dataUrl => {
        ...
        img.src = dataUrl;
        img.style.width = '100%';
        img.style.height = 'auto'; // 设置高度为自动
        // img.style.maxWidth = '612px'; // 设置最大宽度，避免图片过大
...
//   }, []);
  ...
  return (
    <>
<div ref={contentRef} className="text-black w-[396px] h-[612px] bg-white border border-gray-400 m-2 p-1">
{/* Top Content */}
<div className='flex justify-between items-center'>
  <div className='text-center flex-1'>
    <div className='text-md font-bold text-black'>吴昊</div>
...
<div className='flex justify-between'>
  <div className='ml-3'>
    <p className='inline text-[0.6rem] font-bold text-black'>东北大学</p>
    ...
    <div className='mr-3 pt-2 text-[0.6rem]'>
      <p className='inline text-[0.6rem] tracking-wider '>2019年9月-2023年6月</p>
    </div>
  </div>

<div className='flex justify-between'>
<div className='ml-3 text-[0.55rem] tracking-widest'>
...
<div className='flex justify-between'>
  <div className='ml-3'>
    <p className='inline text-[0.6rem] font-bold'>东北大学</p>
    <div className='ml-1 p-0.5 rounded-sm w-10 inline text-[0.5rem] tracking-widest bg-blue-200 text-blue-700'>985</div>
    <div className='ml-1 p-0.5 rounded-sm w-10 inline text-[0.5rem] tracking-widest bg-blue-200 text-blue-700'>211</div>
    <div className='ml-1 p-0.5 rounded-sm w-10 inline text-[0.5rem] tracking-widest bg-blue-200 text-blue-700'>双一流</div>
  </div>
    <div className='mr-3 pt-2 text-[0.6rem]'>
      <p className='inline text-[0.6rem] tracking-wider'>2023年9月-2026年6月</p>
    </div>
  </div>
...
<div className='pb-1'>
  ...
  <p className='ml-2 pt-0.5 text-[0.45rem]'>5.了解React Native开发，了解其开发流程，调试方法及性能优化。</p>
...
<p className='inline text-[0.5rem]'>React、Drizzle、MySQL、Auth、shadcn、Tailwind</p>
</div>
<div className='leading-2.5'>  
...
<div className='leading-2.5'>  
  ...
  <p className='ml-3 text-[0.5rem]'>2.使用Drizzle对数据库进行初始化，使用SQL来规定数据类型和连接关系，实现React全栈开发。</p>
  <p className='ml-3 text-[0.5rem]'>3.集成切换主题和动画效果，添加富文本编辑器和键盘响应，实现丰富的页面效果</p>
  <p className='ml-3 text-[0.5rem]'>4.自定义Hooks，实现全局的购物车功能。</p>
</div>
</div>
{/* relative */}
